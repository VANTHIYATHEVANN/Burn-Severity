...
st.set_page_config(
    ...
    menu_items={
    'Get help': "https://github.com/VANTHIYATHEVANN/Burn-Severity",
    'Report a bug': "https://github.com/VANTHIYATHEVANN/Burn-Severity/issues",
    'About': "This app was developped by [Ramprasad](https://github.com/VANTHIYATHEVANN/Burn-Severity) for the purpose of environmental monitoring and geospatial analysis and to fulfill Final Year Project terms."
    }
)
...
def main():
    ...
    with st.container():
        ...
        ## Cloud coverage input
            ...
            cloud_pixel_percentage = st.slider(label="cloud pixel rate", min_value=5, max_value=100, step=5, value=30 , label_visibility="collapsed")
